...
- Gradle exit code: 0
- Project root: /home/runner/work/Swrlzcore/Swrlzcore/BUILD_WORK/APK_CF11_276_DISCOVERYAUTH/extracted/SRC_CF7_276_NETPULSE
...
Installed packages:
  ...
  platforms;android-37.1             | 1             | Android SDK Platform 37.1        | platforms/android-37.1            
...
```text
?? ../../
?? ../../../../SRC_CF11_276_DISCOVERYAUTH.zip
```

## Build command

```bash
cd '/home/runner/work/Swrlzcore/Swrlzcore/BUILD_WORK/APK_CF11_276_DISCOVERYAUTH/extracted/SRC_CF7_276_NETPULSE/android' && ./gradlew --no-daemon --stacktrace clean assembleDebug
```
