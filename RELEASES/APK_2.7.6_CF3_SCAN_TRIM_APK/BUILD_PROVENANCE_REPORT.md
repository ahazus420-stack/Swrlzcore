...
- Gradle exit code: 0
- Project root: /home/runner/work/Swrlzcore/Swrlzcore/BUILD_WORK/APK_2.7.6_CF3_SCAN_TRIM/extracted/SRC_2.7.6_CF3_SCAN_TRIM
...
- Android versionName: 0.2.7.6-codefix3-scan-trim
- Android versionCode: 25
- Patch label: 2.7.6-CODEFIX3-DISCOVERY-SCAN-TRIM
- Roadmap revision: 2.7.6
- Build line: Network Discovery / device-subnet-first scan / loopback sweep toggle / short output names / Admin Registry bridge
- Source ZIP: SRC_2.7.6_CF3_SCAN_TRIM.zip
- Patch notes: CODEFIX3: Scan Local skips 127.0.0.x range by default, adds saved loopback-range toggle, and uses short mobile-readable output names.
...
```text
?? ../../
?? ../../../../SRC_2.7.6_CF3_SCAN_TRIM.zip
```

## Build command

```bash
cd '/home/runner/work/Swrlzcore/Swrlzcore/BUILD_WORK/APK_2.7.6_CF3_SCAN_TRIM/extracted/SRC_2.7.6_CF3_SCAN_TRIM/android' && ./gradlew --no-daemon --stacktrace clean assembleDebug
```
...
Output dir: /home/runner/work/Swrlzcore/Swrlzcore/BUILD_WORK/APK_2.7.6_CF3_SCAN_TRIM/extracted/SRC_2.7.6_CF3_SCAN_TRIM/APK_DOWNLOAD
Output base: APK_2.7.6_CF3_SCAN_TRIM
...
> Task :app:compileDebugKotlin
w: file:///home/runner/work/Swrlzcore/Swrlzcore/BUILD_WORK/APK_2.7.6_CF3_SCAN_TRIM/extracted/SRC_2.7.6_CF3_SCAN_TRIM/android/app/src/main/java/sh/swurlz/core/SwrlzNetworkDiscovery.kt:16:85 '@Deprecated(...) @DeprecatedSinceKotlin(...) @InlineOnly() fun String.toLowerCase(): String' is deprecated. Use lowercase() instead.
w: file:///home/runner/work/Swrlzcore/Swrlzcore/BUILD_WORK/APK_2.7.6_CF3_SCAN_TRIM/extracted/SRC_2.7.6_CF3_SCAN_TRIM/android/app/src/main/java/sh/swurlz/core/service/SwurlzAccessibilityService.kt:71:55 '@Deprecated(...) static fun obtain(p0: AccessibilityNodeInfo!): AccessibilityNodeInfo!' is deprecated. Deprecated in Java.
