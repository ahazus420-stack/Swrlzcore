...
- **Prepared CLIENT repair:** `CLIENT_CFv2.0.54_SWRLZ.zip` with matching SHA-256; pending Forge upload and GitHub build.
- **Repository SERVER package:** `SERVER_CFv2.0.37_SWRLZ.zip` with matching SHA-256; current test build result pending.
